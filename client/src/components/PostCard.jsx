                    ...
                    <div className="flex items-center justify-between gap-2 min-w-0 w-full">
                      <div className="flex items-center gap-2 min-w-0">
                        {commentAvatar ? (
                          ...
                          <div className="w-5 h-5 rounded-full bg-gradient-to-tr from-slate-800 to-slate-900 border border-white/10 flex items-center justify-center text-[9px] font-black text-slate-300 uppercase shrink-0">
                            {comment.author?.username ? comment.author.username.charAt(0) : <User size={8}/>}
                          </div>
                        )}
